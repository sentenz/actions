...
The examples workflows directory contains files demonstrating how to use the centralized GitHub Actions.
...
- Replace `@latest` with a specific version tag for production use
